...
def train(trainDataset, model, optimizer, criterion, logger, start_epoch):
    ...
    for epoch in range(start_epoch, epochs):
        ...
        for batch, sample in enumerate(trainImgLoader):
            ...
            print(
                'Epoch {}/{}, Iter {}/{}, train loss = {:.3f}, time = {:.3f}'.format(epoch, epochs, batch,
                                                                                    len(trainImgLoader), tensor2float(loss),
...
@make_nograd_func
def test(testDataset, model, optimizer, criterion, logger, start_epoch):
...
def main():
    ...
    model = MVSNet1(refine=False).to('cuda')
    ...
    if mode == 'test':
        ...
        test(testDataset, model, optimizer, criterion, logger, start_epoch)
