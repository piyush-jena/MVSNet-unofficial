...
print("Total Arguments:", sys.argv[1:])
print_args(args)

# dataset, dataloader
trainDataset = MVSDataset(args.trainpath, args.trainlist, "train", 3, args.numdepth, args.interval_scale)
testDataset = MVSDataset(args.testpath, args.testlist, "test", 5, args.numdepth, args.interval_scale)
trainImgLoader = DataLoader(trainDataset, args.batch_size, shuffle=True, num_workers=8, drop_last=True)
testImgLoader = DataLoader(testDataset, args.batch_size, shuffle=False, num_workers=4, drop_last=False)
...
if (args.mode == "train" and args.resume) or (args.mode == "test" and not args.loadckpt):
    ...
    print("loading checkpoint {}".format(args.loadckpt))
